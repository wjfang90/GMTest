...
namespace KYSharp.SM.Core.Test.SM.SM2
{
    public class SM2Utils
    {
        public static void GenerateKeyPair()
        {
            ...
            Console.Out.WriteLine("私钥: " + Encoding.Default.GetString(Hex.Encode(privateKey.ToByteArray())).ToUpper());
        }

        public static void GenerateKeyPair(out string publicKey, out string privateKey)
        {
            AsymmetricCipherKeyPair asymmetricCipherKeyPair = SM2.Instance.EccKeyPairGenerator.GenerateKeyPair();
        ...
        /// <returns></returns>
        public static byte[] Decrypt(string privateKeyStr, string encryptedDataStr, Encoding encoding, SM2Model model)
        {
